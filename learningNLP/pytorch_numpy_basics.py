...
rot90left = torch.tensor([[0, -1],
                          [1, 0]])
combineTransforms = rot90right.mm(
    rot90left)  # will be identity matrix.note mm or matmul will work
rotatePointBy90 = rot90right.mv(
    aVector)  # 1,1 but rotated so 1,-1. note matmul or mv will work
