...
processedText = bag2.map(json.dumps).to_textfiles(path.join(processedDir, 'tokens-*.txt')) #change compute() to take(10) for testing

# tokenList = Tokenizer().proc_all_mp(processedText, 'en')
